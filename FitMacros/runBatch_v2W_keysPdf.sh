...
anaBct=0 #0: do b-fit(not-analytic fit for b-lifetime), 1: do b-fit(analytic fit for b-lifetime), 2: do NOT b-fit
...
################################################################ 
#program 0.0-0.4 6.5-30.0 ${centcoarser3[@]}
#program 0.4-0.8 6.5-30.0 ${centcoarser3[@]}
#program 0.8-1.2 6.5-30.0 ${centcoarser3[@]}
