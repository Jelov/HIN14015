...
ctauErrFile=/afs/cern.ch/user/m/miheejo/public/HIN-14-005/FitScripts/PbPb_v2noW_ctauErrorRange_step8 # Location of ctau error range file
...
#dphibins=(0.000-1.571 0.000-0.785 0.785-1.571)
...
rapcoarser2=(0.0-1.2 1.2-1.6 1.6-2.4 1.2-2.4)
rapcoarser4=(1.6-2.4)
...
centcoarser2=(0.0-5.0 5.0-10.0 10.0-15.0 15.0-20.0 20.0-25.0 25.0-30.0 30.0-40.0 40.0-50.0 50.0-60.0 60.0-100.0)
centcoarser3=(0.0-10.0 10.0-20.0 20.0-30.0 30.0-40.0 40.0-50.0 50.0-100.0)
centcoarser4=(0.0-10.0 10.0-20.0 20.0-30.0 30.0-60.0 60.0-100.0)
...
program 1.6-2.4 6.5-30.0 ${centcoarser5[@]}
program 1.6-2.4 3.0-6.5 ${centcoarser5[@]}
...
for pt in ${ptcoarser4[@]}; do
  program 1.6-2.4 $pt 10.0-60.0
done
