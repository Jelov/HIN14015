...
int main(int argc, char *argv[]) {
  ...
  TChain ch("myTree");
  if (npmc) {
    ch.AddFile("/tmp/camelia/bJpsiMuMu_JpsiPt03_Histos_cmssw445p1_RegIt.root");
    ch.AddFile("/tmp/camelia/bJpsiMuMu_JpsiPt36_Histos_cmssw445p1_RegIt.root");
    ch.AddFile("/tmp/camelia/bJpsiMuMu_JpsiPt69_Histos_cmssw445p1_RegIt.root");
    ch.AddFile("/tmp/camelia/bJpsiMuMu_JpsiPt912_Histos_cmssw445p1_RegIt.root");
    ch.AddFile("/tmp/camelia/bJpsiMuMu_JpsiPt1215_Histos_cmssw445p1_RegIt.root");
    ch.AddFile("/tmp/camelia/bJpsiMuMu_JpsiPt1530_Histos_cmssw445p1_RegIt.root");
  } else { 
    ch.AddFile("/tmp/camelia/jpsiMuMu_JpsiPt03_Histos_cmssw445p1_RegIt.root");
    ch.AddFile("/tmp/camelia/jpsiMuMu_JpsiPt36_Histos_cmssw445p1_RegIt.root");
    ch.AddFile("/tmp/camelia/jpsiMuMu_JpsiPt69_Histos_cmssw445p1_RegIt.root");
    ch.AddFile("/tmp/camelia/jpsiMuMu_JpsiPt912_Histos_cmssw445p1_RegIt.root");
    ch.AddFile("/tmp/camelia/jpsiMuMu_JpsiPt1215_Histos_cmssw445p1_RegIt.root");
    ch.AddFile("/tmp/camelia/jpsiMuMu_JpsiPt1530_Histos_cmssw445p1_RegIt.root");
  }
