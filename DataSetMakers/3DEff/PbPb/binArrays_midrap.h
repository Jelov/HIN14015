static const double yarray[]        = {0, 0.8, 1.2, 1.6};
static const double ptarray[]       = {6.5, 7.5, 8.5, 9.5, 11.0, 13.0, 16.0, 30.0};
static const double ctauarray[]     = {0, 0.3, 0.5, 0.8, 1.2, 1.6, 2.0, 2.5, 3.0, 4.0, 5.0, 7.0, 10.0};
static const double ctauforwarray[] = {0, 0.4, 0.8, 1.2, 1.6, 3.0, 5.0, 7.0, 10.0};
