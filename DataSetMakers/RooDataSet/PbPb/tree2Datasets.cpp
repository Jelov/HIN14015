...
const double _ptarr[] = {6.5, 8.5, 11.0, 16.0, 30}; 
const double _ptforwarr[] = {3.0, 6.5, 8.5, 11.0, 16.0, 30};
...
int main(int argc, char* argv[]) {
  ...
  if (doWeighting) {
    ...
    string dirPath = "/home/mihee/cms/RegIt_JpsiRaa/Efficiency/PbPb/RegionsDividedInEta/";
//    string dirPath = "/home/mihee/cms/RegIt_JpsiRaa/Efficiency/pp/";
...
//    cout << endl;
    ...
    if (trigType == 3 || trigType == 4) {
      if (isPbPb)
        sprintf(effHistname,"/home/mihee/cms/RegIt_JpsiRaa/datasets/PbPb/RecoLxyEff_RegionsDividedInEta/FinalEfficiency_pbpb_notAbs.root");
      else
        sprintf(effHistname,"/home/mihee/cms/RegIt_JpsiRaa/datasets/FinalEfficiency_pp_notAbs.root");
...
bool isAccept(const TLorentzVector* aMuon) {
  if (fabs(aMuon->Eta()) < 1.6) return true;
  else return false;
}
